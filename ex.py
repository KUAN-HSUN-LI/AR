...
def get_args():
    ...
    parser.add_argument("--input_img", "-i", type=image, default="Mid.png")
...
def angle_diff(img_angle, pointO, pointA, pointB, diff):
    ...
    B2 = sy.Symbol('b2')
    C2 = sy.Symbol('c2')
    return diff.subs([(IMG_ANGLE, img_angle), (X, x), (Y, y), (Z, z), (A1, a1), (B1, b1), (C1, c1), (A2, a2), (B2, b2), (C2, c2)])
...
if __name__ == "__main__":
    ...
    print("AOB", real_angle_AOB, img_angle_AOB)
    print("BOC", real_angle_BOC, img_angle_BOC)
    print("COA", real_angle_COA, img_angle_COA)
    print(CAMERA)
    lr = 0.5
    ...
    print("COA", real_angle_COA, img_angle_COA)
    print(CAMERA)
    print("distance OA =", calc_dist(CAMERA, REAL_A))
    print("distance OB =", calc_dist(CAMERA, REAL_B))
    print("distance OC =", calc_dist(CAMERA, REAL_C))
